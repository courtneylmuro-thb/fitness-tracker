      ...
      <div className="card">
        ...
        <div className="row" style={{ justifyContent: "center", gap: 24, marginTop: 8 }}>
          <div style={{ textAlign: "center" }}>
            <div className="subtle">Burned{data?.burnedTodayIsEstimate ? " (est.)" : ""}</div>
            <div style={{ fontWeight: 700 }}>
              {data?.burnedToday ? `${data.burnedTodayIsEstimate ? "~" : ""}${Math.round(data.burnedToday)}` : "—"}
            </div>
          </div>
          <div style={{ textAlign: "center" }}>
        ...
        {data?.burnedTodayIsEstimate && (
          <div className="subtle" style={{ textAlign: "center", marginTop: 6, fontSize: 12 }}>
            Today's burn is estimated from your recent average -- your watch data syncs overnight.
          </div>
        )}
      </div>
